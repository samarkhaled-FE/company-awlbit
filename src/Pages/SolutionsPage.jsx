...
const handleScrollToEHR = (e) => {
    ...
    // ✅ العثور على قسم "أنظمة المستشفيات المتكاملة" 
    const ehrSection = document.getElementById('ehr');
    
    if (ehrSection) {
        // ✅ حساب المسافة مع مراعاة الـ navbar
        const navbar = document.querySelector('.navbar');
        const navbarHeight = navbar ? navbar.getBoundingClientRect().height : 72;
        const elementTop = ehrSection.getBoundingClientRect().top + window.pageYOffset;
        const offset = elementTop - navbarHeight - 20; // 20px extra space
        
        // ✅ السكرول المضبوط للقسم
        window.scrollTo({
            top: offset,
            behavior: 'smooth'
        });
        
        // ✅ تحديث الـ URL (اختياري)
        setTimeout(() => {
            window.history.pushState(null, null, '#ehr');
        }, 300);
    }
};

// ✅ وعدل الزر ليبقى يشتغل عادي بدون تغيير الـ state
<div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
    <button 
        onClick={handleScrollToEHR}
        className="inline-flex items-center gap-3 bg-white text-[#0B1A2C] px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-xl cursor-pointer"
    ...
    return (
        <div className="solutions-page">
            ...
            {/* ✅ Hero Section - يظهر في جميع الحالات */}
            <section 
                className="hero-section py-20 text-white relative overflow-hidden"
                style={{
                    background: 'linear-gradient(135deg, #0B1A2C 0%, #1e3a8a 50%, #059669 100%)',
            ...
            >
                    ...
                    <div className="max-w-5xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
                            {!showEHRDirect ? (
                                ...
                                <button 
                                    onClick={() => {
                                        const ehrSection = document.getElementById('ehr-content');
                                        if (ehrSection) {
                                            ehrSection.scrollIntoView({ behavior: 'smooth', block: 'start' });
                                        }
                                    }}
                                    className="inline-flex items-center gap-3 bg-white text-[#0B1A2C] px-8 py-4 rounded-full font-bold text-lg hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-xl cursor-pointer"
                                >
                ...
                {/* ✅ إضافة Scroll Indicator (الماوس المتحرك) */}
            ...
            {/* ✅ Introduction Section - قبل EHRSection */}
            {!showEHRDirect && (
                <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
                    <div className="container mx-auto px-6 text-center">
                        <div className="max-w-4xl mx-auto">
                            {/* العنوان الرئيسي */}
                            <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{color:'#0B1B2D'}}>
                                {isArabic ? "حلولنا المتطورة" : "Our Advanced Solutions"}
                            </h2>
                            
                            {/* الفقرة التوضيحية */}
                            <p className="text-lg text-gray-600 leading-relaxed mb-8 max-w-3xl mx-auto">
                                {isArabic 
                                    ? "نقدم مجموعة شاملة من الحلول التقنية المتطورة المصممة خصيصاً لتلبية احتياجات المؤسسات الحديثة. حلولنا تجمع بين التكنولوجيا المتقدمة والخبرة العميقة لضمان تحقيق أهدافك بكفاءة وفعالية."
                                    : "We offer a comprehensive range of advanced technical solutions specifically designed to meet the needs of modern institutions. Our solutions combine cutting-edge technology with deep expertise to ensure your goals are achieved efficiently and effectively."
                                }
                            </p>
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                                <div className="text-center">
                                    <div className="text-3xl font-bold mb-2" style={{color:'#0B1B2D'}}>50+</div>
                                    <div className="text-sm text-gray-600">
                                        {isArabic ? "مشروع ناجح" : "Successful Projects"}
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="text-3xl font-bold mb-2" style={{color:'#0B1B2D'}}>99%</div>
                                    <div className="text-sm text-gray-600">
                                        {isArabic ? "نسبة الرضا" : "Satisfaction Rate"}
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="text-3xl font-bold mb-2" style={{color:'#0B1B2D'}}>24/7</div>
                                    <div className="text-sm text-gray-600">
                                        {isArabic ? "دعم تقني" : "Technical Support"}
                                    </div>
                                </div>
                                <div className="text-center">
                                    <div className="text-3xl font-bold mb-2" style={{color:'#0B1B2D'}}>5+</div>
                                    <div className="text-sm text-gray-600">
            ...
            {/* ✅ EHR Content Section للـ Direct view */}
            {showEHRDirect && (
                <div className="ehr-direct-view" id="ehr-content">
                    <section className="bg-white py-16">
                        <div className="container mx-auto px-6">
                            <EHRSection />
